...
{
    public MainWindow(RepositoryWorkspaceViewModel viewModel, TerminalViewModel terminalViewModel, CommandsViewModel commandsViewModel)
    {
        InitializeComponent();
        ...
        RootHost.Children.Add(new RepositoryWorkspacePage(viewModel, terminalViewModel, commandsViewModel, openCoordinator));
    }
}
