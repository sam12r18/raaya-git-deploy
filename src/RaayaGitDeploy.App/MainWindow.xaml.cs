...
{
    public MainWindow(RepositoryWorkspaceViewModel viewModel, TerminalViewModel terminalViewModel)
    {
        InitializeComponent();
        ...
        RootHost.Children.Add(new RepositoryWorkspacePage(viewModel, terminalViewModel, openCoordinator));
    }
}
